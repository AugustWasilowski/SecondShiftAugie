...
# from nextcord import slash_command as app_commands
...
class aclient(discord.Client):
    def __init__(self) -> None:
        ...
        # self.tree = nextcord.ext.commands.Command.CommandTree(self)
    ...
    def get_chatbot_model(self, prompt=prompt) -> Union[AsyncChatbot, Chatbot]:
        if self.chat_model == "UNOFFICIAL":
            return AsyncChatbot(config={"email": self.openAI_email, "password": self.openAI_password,
                                        "access_token": self.chatgpt_access_token, "model": self.openAI_gpt_engine,
